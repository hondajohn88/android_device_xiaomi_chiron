...
public class ProximitySensor implements SensorEventListener {
    ...
    private static final String CHIRON_FPC_FILE =
            "/sys/devices/soc/soc:fpc_fpc1020/proximity_state";
    private static final String CHIRON_GOODIX_FILE =
    ...
    public ProximitySensor(Context context) {
        ...
        if (FileUtils.fileExists(CHIRON_FPC_FILE)) {
            FPC_FILE = CHIRON_FPC_FILE;
            found = true;
        } else if (FileUtils.fileExists(CHIRON_GOODIX_FILE)) {
            FPC_FILE = CHIRON_GOODIX_FILE;
            found = true;
        } else {
